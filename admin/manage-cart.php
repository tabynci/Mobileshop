  ...
  <?php 
    ...
    {?>
        ...
        <tr>
            ...
            <td scope="row"><?php echo $result['product_id'];?></td>
            <td scope="row"><?php echo $result['product_name'];?></td>
            <td scope="row"><?php echo $result['user'];?></td>
            <td scope="row"><?php echo $result['price'];?></td>
            <td scope="row"><?php echo $result['purchased_date'];?></td>
              <td scope="row">
